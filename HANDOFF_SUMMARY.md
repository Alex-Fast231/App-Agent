...
**Stand:** 2026-08-31 (Session-Ende, achte Session: Korrekturrunde zu sieben Punkten, u.a. Teil-Rückgängigmachung der Hausbesuch-Entfernung aus der siebten Session)
...
Diese Datei ersetzt die vorherige Version vom 2026-08-22 (siebte Session) vollständig. Die siebte Session bleibt unten in Abschnitt 7 als historische Dokumentation stehen.

**WICHTIG für den schnellen Einstieg:**
- **Abschnitt 8 (ganz unten vor "Was noch aussteht") beschreibt die aktuellste Session** - eine Korrekturrunde zu 7 vom Nutzer gemeldeten Punkten, u.a. eine **Teil-Korrektur** der Hausbesuch-Entfernung aus Abschnitt 7f: das Rezept-Feld "Hausbesuch (Ja/Nein)" (Pflichtfeld-Prüfung) wurde wiederhergestellt, während die Patienten-Checkbox `patient.hb` und die davon abhängige Nachbestellzettel-Adresslogik korrekterweise entfernt bleiben. Bei künftigen Änderungen an diesem Bereich unbedingt zwischen den beiden ursprünglich ähnlich benannten, aber unabhängigen Feldern unterscheiden.
